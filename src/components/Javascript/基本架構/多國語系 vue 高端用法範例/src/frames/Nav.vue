    ...
    <div class="test">
        <nav class id="navMenu" :ref="'navMenu'">
            <div id="navMenuTitle" @click="menuClose">
                <span>{{language[locale].Navbar.title}}</span>
            ...
            <div id="navMenuSearchbar">
                <div class="inputWrap">
                    <input :placeholder="language[locale].Navbar.searchBarPlaceHolder" type="text" />
                    <img src="./svg/Magnifier - simple-line-icons Copy.svg" id="magnifier" alt />
                </div>
            </div>
            <div id="menuGroups">
                <ul v-if="switchMenu===navTab[0]" class="menuGroups__list">
                    <li
...
export default {
    ...
    methods: {
        ...
        initPageLanguage: function () {
            ...
            let navTab = Object.values(language[locale].Navbar.meanuOption);
            this.locale = locale;
            this.switchMenu = navTab[0];
            this.navTab = navTab;
        },
