<template>
    <div :class="`dd-w-${width}`" class="blockTtileDropdown">
        <kendo-dropdownlist
...
export default {
    ...
    methods: {
        ...
        onSelect: function (e) {
            console.log("Event :: select", e.dataItem.text);
            this.select = e.dataItem.text;
    ...
    mounted() {
        this.$nextTick(() => {
            this.select = this.dataSourceArray[0]
        })
    }
...
.blockTtileDropdown {
    ...
    .k-dropdowntree .k-dropdown-wrap .k-input::before {
        width: 16px;
        height: 16px;
        padding-right: 10px;
    }
...
.dd-w-50 .k-dropdown,
.dd-w-50 .k-dropdowntree {
    width: 50%;
}
.dd-w-100 .k-dropdown,
.dd-w-100 .k-dropdowntree {
    width: 100%;
}

.dd-w-1 .k-dropdown,
.dd-w-1 .k-dropdowntree {
    width: 80px;
}
.dd-w-2 .k-dropdown,
.dd-w-2 .k-dropdowntree {
    width: 184px;
}
.dd-w-3 .k-dropdown,
.dd-w-3 .k-dropdowntree {
    width: 392px;
}
.dd-w-4 .k-dropdown,
.dd-w-4 .k-dropdowntree {
    width: 600px;
}
.dd-w-5 .k-dropdown,
.dd-w-5 .k-dropdowntree {
    width: 1224px;
}
</style>
